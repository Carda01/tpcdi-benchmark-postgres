...
def customermgmt_convert(**kwargs):
    SF = kwargs['SF']
    with open(f'dags/data/sf_{SF}/Batch1/CustomerMgmt.xml') as fd:
    ...
    cust_df.to_csv(f'dags/data/sf_{SF}/Batch1/CustomerMgmt.csv', index = False)
