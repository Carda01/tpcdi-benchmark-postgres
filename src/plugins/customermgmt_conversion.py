...
def customermgmt_convert():
    with open('dags/data/sf3/Batch1/CustomerMgmt.xml') as fd:
        doc = xmltodict.parse(fd.read()) 
        fd.close()

    with open("dags/data/sf3/Batch1/CustomerData.json", "w") as outfile:
        outfile.write(json.dumps(doc))
        outfile.close()

    f = open('dags/data/sf3/Batch1/CustomerData.json','r')
    ...
    cust_df.to_csv('dags/data/sf3/Batch1/CustomerMgmt.csv', index = False)
